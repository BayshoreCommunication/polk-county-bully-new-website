      ...
      <div className="container mx-auto px-8 text-center text-white">
        ...
        <Reveal y={-100} duration={2}>
          <h2 className="text-3xl md:text-7xl  font-extrabold mb-8 drop-shadow-lg  tracking-wider">
            <span className=" text-[#FFFFFF] drop-shadow-[6px_6px_0px_#000]">
              ARE YOU READY
            </span>
            <span className="bg-gradient-to-r from-[#F7734E] to-[#F44B80] text-transparent bg-clip-text drop-shadow-[6px_6px_0px_#000]">
              {" "}
              TO GIVE ONE OF OUR BEAUTIFUL <br />
              BULLIES
            </span>
            <span className="bg-gradient-to-r from-[#FACC15] to-[#2BFD27] text-transparent bg-clip-text drop-shadow-[6px_6px_0px_#000]">
              {" "}
              A FOREVER HOME?
            </span>
          </h2>
        ...
        <div className="mb-8 flex justify-center">
          <Image
            ...
            width={600}
            height={400}
            className="rounded-xl shadow-lg object-cover w-full max-w-5xl"
          />
        </div>
        ...
        <Reveal y={100} duration={2}>
          <p className="text-sm md:text-base  mb-6 max-w-7xl mx-auto text-start">
            ...
            see all of the dogs who are ready for a forever home here. Once
            you've chosen the dog you’d like to adopt, you can submit your
        ...
        <Reveal y={100} x={100} duration={3}>
          <Link href="https://petstablished.com/adoptions/personal-information?application_type=Adopt&donation_section=false&form_id=24575&form_type=generic&generic_form_id=24575&pet_id=715879&section=1&selected_pets=false">
            <button className=" bg-white text-primary font-bold py-3 px-6 rounded-full shadow-lg transition duration-300">
              Adopt Today
            </button>
          </Link>
        </Reveal>
