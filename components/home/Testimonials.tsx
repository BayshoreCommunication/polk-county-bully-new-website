...
<<<<<<< HEAD
      ...
      <div className="container mx-auto mt-[100px] px-8">
        {/* Heading */}
        <h2 className="text-center text-4xl md:text-7xl font-extrabold text-white drop-shadow-lg mb-3">
          Our{" "}
          <span className="bg-gradient-to-r from-[#F7734E] to-[#F44B80] text-transparent bg-clip-text [filter:drop-shadow(0_2px_4px_rgba(0,0,0,0.5))]">
            Client
          </span>{" "}
          <span className="bg-gradient-to-r from-[#FACC15] to-[#2BFD27] text-transparent bg-clip-text [filter:drop-shadow(0_2px_4px_rgba(0,0,0,0.5))]">
=======
...
>>>>>>> cbe9e6411677a980992135862910598373669fc8
            Testimonial
          </span>
        </h2>
