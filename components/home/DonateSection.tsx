...
export default function DonateSection() {
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-white max-w-lg">
            <Reveal y={-100} duration={2}>
              <h2 className="text-3xl md:text-5xl mb-4 text-stroke-black drop-shadow-[6px_6px_0px_#000] tracking-wider">
                {" "}
            ...
            <Reveal y={-100} duration={3}>
              <p className="text-sm md:text-base mb-6 drop-shadow-md text-white">
                {" "}
                {/* Reduced margin */}
            ...
            <Reveal y={100} x={100} duration={2}>
              <a href="https://app.giveffect.com/charities/27544-polk-county-bully-project">
                <button className="flex items-center gap-2 bg-white text-primary font-semibold px-5 py-2 rounded-full shadow-md hover:shadow-lg transition">
                  {" "}
                  {/* Reduced padding */}
                ...
                <div className="flex gap-4 mt-6">
                  <Link
                    ...
                    className="hover:text-blue-400 transition-colors duration-300 drop-shadow-[0px_6px_0px_#000]"
                  >
                    <IoLogoVenmo className="w-8 h-8 text-white rounded-full hover:scale-110 transition-transform duration-300" />
                  </Link>
                  <Link
                    href="https://www.paypal.com/paypalme/PolkCountyBullyProje  "
                    className="hover:text-blue-700 transition-colors duration-300 drop-shadow-[0px_6px_0px_#000]"
                  >
                    <FaPaypal className="w-8 h-8 text-white rounded-full hover:scale-110 transition-transform duration-300" />
                  </Link>
                  <Link
                    href="https://cash.app/$pcbp"
                    className="hover:text-green-500 transition-colors duration-300 drop-shadow-[0px_6px_0px_#000]"
                  >
                    <SiCashapp className="w-8 h-8 text-white rounded-full hover:scale-110 transition-transform duration-300" />
                  </Link>
                </div>
              </a>
            </Reveal>
          ...
          <div className="flex justify-center">
            <div className="bg-white p-1 rounded-lg shadow-lg max-w-md w-full">
              {" "}
      ...
      <div className="absolute bottom-0 w-full left-0 right-0 h-12 bg-gradient-to-b from-transparent to-white "></div>{" "}
      {/* Reduced height */}
    </section>
  );
}
